...
namespace ASFUnpaidStuff.ASFExtensions.Games;
...
public readonly record struct GameIdentifier(long Id, GameIdentifierType Type = GameIdentifierType.None) {
	...
	public static bool TryParse(ReadOnlySpan<char> query, out GameIdentifier result) => GameIdentifierParser.TryParse(query, out result);
}
