...
internal sealed record PluginContext(IReadOnlyCollection<Bot> Bots, IContextRegistry BotContexts, ASFUnpaidStuffOptions Options, LoggerFilter LoggerFilter, bool Valid = false) {
	/// <summary>
